...
export default function Message({ role, content, isStreaming }) {
    ...
    return (_jsx("div", { style: { display: "flex", justifyContent: cfg.align, animation: "fadeIn .2s ease" }, children: _jsxs("div", { style: {
                maxWidth: "76%", padding: "10px 14px", borderRadius: 12,
                background: cfg.bg, borderLeft: `3px solid ${cfg.border}`,
                boxShadow: "0 1px 4px rgba(0,0,0,.06)",
                animation: "fadeIn .2s ease",
            }, children: [_jsx("div", { style: { fontSize: 11, fontWeight: 700, color: "#6b7280", marginBottom: 5, textTransform: "uppercase", letterSpacing: ".04em" }, children: cfg.label }), _jsxs("div", { style: { fontSize: 14, lineHeight: 1.6, whiteSpace: "pre-wrap", color: "#1f2937" }, children: [content, isStreaming && (_jsx("span", { style: { display: "inline-block", width: 2, height: "1em",
